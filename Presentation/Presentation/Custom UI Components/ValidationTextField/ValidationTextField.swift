...
//  Presentation
//
//  Created by prog_zidane on 1/19/21.
//
...
public class ValidationTextField: DesignableTextField {
    ...
    public var errorMessage:String = ""{
        didSet{ assignNewText() }
    }
    
    public var animateFloatPlaceholder:Bool = true
    public var hideErrorWhenEditing:Bool   = true
    
    public var errorFont = UIFont.localizedFont(size: .size11, weight: .regular) {
        didSet{
    ...
    public var floatPlaceholderFont = UIFont.localizedFont(size: .size11, weight: .regular){
        didSet{
    ...
    static let defaultBorderColor = UIColor(red: 204.0/255.0, green: 204.0/255.0, blue: 204.0/255.0, alpha: 1.0)
    
    public var borderColor:UIColor = defaultBorderColor{
        didSet{
            switch dtborderStyle {
    ...
    fileprivate func commonInit() {
        ...
        dtLayer.backgroundColor     = backgroundColor?.cgColor
    ...
    fileprivate func assignNewText() {
        // Create Attachment
        let imageAttachment = NSTextAttachment()
        imageAttachment.image = #imageLiteral(resourceName: "circleError")
        ...
        let textAfterIcon = NSAttributedString(string: "   "  + errorMessage, attributes: [.font: errorFont])
        completeText.append(textAfterIcon)
        self.lblError.attributedText = completeText
    ...
    fileprivate func hideErrorMessage(){
        lblError.text = ""
        lblError.attributedText = nil
        lblError.isHidden = true
        lblError.frame = CGRect.zero
        borderColor = ValidationTextField.defaultBorderColor
        invalidateIntrinsicContentSize()
    }
